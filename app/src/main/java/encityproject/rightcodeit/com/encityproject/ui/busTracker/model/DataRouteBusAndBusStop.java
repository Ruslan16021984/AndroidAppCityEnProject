...
public class DataRouteBusAndBusStop {
    ...
    public ArrayList<GeoPoint> routeBusTwo() {
    ...
    public ArrayList<GeoPoint> routeBusFour() {
    ...
    public ArrayList<GeoPoint> routeBusFive() {
    ...
    public ArrayList<GeoPoint> routeBusSeven() {
