...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static List<String> datas1 = new ArrayList<>();
    static List<SubCat> sCList=new ArrayList<>();
    static List<String> children1 = new ArrayList<>();
    static RecyclerAdapter recyclerAdapter;
    public RecyclerView recyclerView;
    static List<Entity> general;

    public RecyclerAdapter(RecyclerView recyclerView, List<String> datas1) {
    ...
    public void setParent(){
        ...
        for(int i=0;i<datas1.size();i++){
           String[] s= datas1.get(i).split(";")[1].split(",");
            sCList.add(new SubCat(datas1.get(i).split(";")[1],s));
        }
    }
...
//        return 0;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == CHILD){
            ...
            SubCat subCat = sCList.get(position);
