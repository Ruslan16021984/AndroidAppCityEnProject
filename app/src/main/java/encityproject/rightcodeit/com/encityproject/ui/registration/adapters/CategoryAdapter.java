package encityproject.rightcodeit.com.encityproject.ui.registration.adapters;
...
import encityproject.rightcodeit.com.encityproject.ui.market.ListItemClickListener;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public CategoryAdapter(Context context, Activity mActivity, ArrayList<CategoryModel> categoryList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_category_recycler, viewGroup, false);
        return new ViewHolder(view, i, itemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        final CategoryModel model = categoryList.get(i);

        String categoryName = model.getCategoryName();
        holder.tvCategoryTitle.setText(Html.fromHtml(categoryName));
        holder.tvCategoryId.setText(String.valueOf(i + 1));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ListItemClickListener itemClickListener;
        public ViewHolder(@NonNull View itemView, int i, ListItemClickListener itemClickListener) {
            super(itemView);
            this.itemClickListener = itemClickListener;
